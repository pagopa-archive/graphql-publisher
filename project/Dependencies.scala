...
object Dependencies {
  ...
  lazy val bck = "org.bouncycastle" % "bcprov-jdk15on" % "1.68"
  lazy val jwt = "com.auth0" % "java-jwt" % "3.12.0"
  lazy val catsCore = "org.typelevel" %% "cats-core" % "2.3.1"
  lazy val catsKernel = "org.typelevel" %% "cats-kernel" % "2.3.1"
  lazy val catsFree = "org.typelevel" %% "cats-free" % "2.3.1"
  ...
  lazy val hiveJdbc = "org.apache.hive" % "hive-jdbc" % "3.1.3000.7.2.6.1-1" exclude("org.slf4j", "slf4j-log4j12") exclude("org.apache.logging.log4j", "log4j-slf4j-impl") exclude("org.apache.logging.log4j", "log4j-1.2-api")
