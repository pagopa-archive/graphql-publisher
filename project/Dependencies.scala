...
object Dependencies {
  ...
  lazy val jwt = "com.auth0" % "java-jwt" % "3.17.0"
  ...
  lazy val hiveJdbc = "org.apache.hive" % "hive-jdbc" % "3.1.3000.7.2.10.0-148" exclude("org.slf4j", "slf4j-log4j12") exclude("org.apache.logging.log4j", "log4j-slf4j-impl") exclude("org.apache.logging.log4j", "log4j-1.2-api")
