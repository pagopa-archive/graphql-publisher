...
object Dependencies {
  ...
  lazy val jwt = "com.auth0" % "java-jwt" % "3.16.0"
  ...
  lazy val sangria = "org.sangria-graphql" %% "sangria" % "2.1.3"
  ...
  lazy val hiveJdbc = "org.apache.hive" % "hive-jdbc" % "3.1.3000.7.2.9.0-203" exclude("org.slf4j", "slf4j-log4j12") exclude("org.apache.logging.log4j", "log4j-slf4j-impl") exclude("org.apache.logging.log4j", "log4j-1.2-api")
